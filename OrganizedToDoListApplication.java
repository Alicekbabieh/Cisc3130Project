...
public class OrganizedToDoListApplication {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to the text-based ToDoList App");
        ...
        while (true) {
            ...
            try {
                switch (keyWord) {
                    case "add":
                        ...
                        while (true) {
                            ...
                            if (taskList.containsTask(taskName)) {
                                System.out.print("Duplicate task name detected. Do you still want to add this task? (yes/no): ");
                    ...
                    default:
                        System.out.println("Try again. Entered wrong key word.");
                }
